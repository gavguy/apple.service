...
import apple.core.service.bookshelf.auth.model.Role;
...
public class AuthenticationMechanism implements HttpAuthenticationMechanism {
    ...
    private boolean isUser(HttpServletRequest request) {
        return isAdmin(request) || isManager(request) || request.isUserInRole(Role.USER.toString());
    }

    private boolean isManager(HttpServletRequest request) {
        return isAdmin(request) || request.isUserInRole(Role.MANAGER.toString());
    }
